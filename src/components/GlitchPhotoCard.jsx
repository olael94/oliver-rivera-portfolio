...
const GlitchPhotoCard = ({ src, alt, name, title, className }) => {
  return (
    <div className={`group relative w-fit max-md:w-full ${className}`}>
      ...
      <div
        className="neu-frame relative rounded-2xl p-3 sm:p-4 overflow-hidden aspect-[4/5] w-[420px] max-w-full max-md:rotate-0 -rotate-3 group-hover:rotate-0 transition-all duration-500 ease-out"
