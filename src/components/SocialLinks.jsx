        ...
        {socialLinks.map((socialLink, index) => (
          <li key={index} className="py-2.5">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center text-[16px] text-zinc-600 no-underline hover:text-lime-500 dark:text-zinc-400 dark:hover:text-lime-400 transition-colors"
            >
